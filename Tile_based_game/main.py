...
class Game:
    ...
    def load_data(self):
        ...
        self.map_folder = path.join(img_folder, 'maps')
        ...
        self.bullet_imgages = {}
        self.bullet_imgages["lg"] = pg.image.load(path.join(img_folder, BULLET_IMG)).convert_alpha()
        self.bullet_imgages["sm"] = pg.transform.scale(self.bullet_imgages["lg"],(10,10))
        ...
        for type in EFFECTS_SOUNDS:
            ...
            self.effect_sounds[type].set_volume(0.1)
        self.weapon_sounds = {}
    ...
    def draw(self):
        ...
        if self.draw_debug:
            for wall in self.walls:
                pg.draw.rect(self.screen, CORNFLOWER, self.camera.apply_rect(wall.rect),1)
    ...
    def show_start_screen(self):
        ...
        self.draw_text("GAME Start", self.hud_font, 100, GREEN, WIDTH / 2, HEIGHT*1 / 4, align="center")
        self.draw_text("Press a key to start", self.hud_font, 75,  BLACK ,WIDTH/ 2, HEIGHT * 3 / 4, align="center")
        self.draw_text("Press space to shoot and p to pause", self.hud_font, 50, BLACK ,WIDTH/ 2, HEIGHT * 7 / 8, align="center")
        pg.display.flip()
        self.wait_for_key()
